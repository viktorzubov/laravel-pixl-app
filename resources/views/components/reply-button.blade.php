<div class="flex items-center gap-1">
    <button aria-label="Comments">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14"
            id="Chat-Bubble-Typing-Oval--Streamline-Core-Remix" height="14" width="14" class="w-3">
            <desc>
                Chat Bubble Typing Oval Streamline Icon:
                https://streamlinehq.com
            </desc>
            <g id="Free Remix/Mail/Mail/Chat Bubble/chat-bubble-typing-oval--messages-message-bubble-typing-chat">
