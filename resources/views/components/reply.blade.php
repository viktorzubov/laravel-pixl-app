    ...
    <div class="border-pixl-light/10 grow border-b pt-1.5 pb-5">
        <div class="flex items-center justify-between gap-4">
            <div class="flex items-center gap-2.5">
                <p>
                    <a class="hover:underline" href="/profile">{{ $post->profile->name }}</a>
                </p>
                <p class="text-pixl-light/40 text-xs">{{ $post->postedDateTime }}</p>
                <p class="text-pixl-light/40 text-xs">
                    <a class="hover:text-pixl-light/60" href="/profile">{{ $post->profile->handle }}</a>
                </p>
            </div>
                ...
                <div class="flex items-center gap-1">
                    <button aria-label="Re-posts">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-0.835 -0.835 20 20" fill="none"
                            ...
                            <path d="m5.34625 16.802500000000002 -3.055 -3.055 3.055 -3.055" stroke-width="1.67"></path>
